...
public class InvoiceService {
    ...
    public InvoiceService() {
        ...
        // Adding 15 sample invoices with random dates, statuses, and line items
        ...
        invoices.add(new Invoice("11", "Cleaning Services", 350.00, LocalDate.now().minusDays(random.nextInt(30)), statuses[random.nextInt(statuses.length)],
            List.of(
                new Invoice.LineItem("Office Cleaning", 200.00),
                new Invoice.LineItem("Window Cleaning", 150.00)
            )));
        invoices.add(new Invoice("12", "Graphic Design", 600.00, LocalDate.now().minusDays(random.nextInt(30)), statuses[random.nextInt(statuses.length)],
            List.of(
                new Invoice.LineItem("Logo Design", 300.00),
                new Invoice.LineItem("Brochure Design", 300.00)
            )));
        invoices.add(new Invoice("13", "Web Hosting", 180.00, LocalDate.now().minusDays(random.nextInt(30)), statuses[random.nextInt(statuses.length)],
            List.of(
                new Invoice.LineItem("Annual Hosting", 180.00)
            )));
        invoices.add(new Invoice("14", "Office Furniture", 950.00, LocalDate.now().minusDays(random.nextInt(30)), statuses[random.nextInt(statuses.length)],
            List.of(
                new Invoice.LineItem("Desk", 400.00),
                new Invoice.LineItem("Chair", 200.00),
                new Invoice.LineItem("Cabinet", 350.00)
            )));
        invoices.add(new Invoice("15", "Security Services", 800.00, LocalDate.now().minusDays(random.nextInt(30)), statuses[random.nextInt(statuses.length)],
            List.of(
                new Invoice.LineItem("Alarm Monitoring", 500.00),
                new Invoice.LineItem("Patrol", 300.00)
            )));
    }
